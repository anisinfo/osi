...
?>	
	 <a class="btn btn-success"  align="left" href="add.php?IdIncident=<?= $_GET['id'];?>">Ajouter Incident</a>	
	 ...
	 ?> 
	  ...
	  <a class="btn btn-success"  href="impact.php?idIncident=<?= $_GET['id'];?>">Ajouter un impact</a>
	  <a class="btn btn-success disabled"  href="">Retour à l'incident</a>
