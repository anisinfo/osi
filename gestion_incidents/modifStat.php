    		...
    		<div class=" width50 mr_35"> 
	    		...
	    		<div class="width100">
	    			...
	    			<div class=" width50">
		    			...
		    			<input type="text"  name="typecause_second" id="stat_typecause_second"  value="<?php getVar('stat_typecause_second'); ?>" >
	    			</div>	
