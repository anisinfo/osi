...
<input type="hidden" name="IdIncident" value="<?php getVarUpdate('IdIncident',$impacte->getIncidentId()); ?>">
	...
	?>
	<a class="btn btn-success"  align="left" href="add.php?IdIncident=<?= $impacte->getIncidentId();?>">Ajouter Incident</a>
	<a class="btn btn-success disable" href="ListeImpact.php?idIncident=<?= $impacte->getIncidentId();?>">Impact</a>
